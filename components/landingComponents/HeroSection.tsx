      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            ...
            <motion.p 
              className="text-lg md:text-xl text-blue-100 max-w-xl mx-auto lg:mx-0"
              variants={itemVariants}
            >
            ...
            >
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="border-white/50 bg-transparent text-white hover:bg-white/10 font-bold px-8 py-7 text-base transition-all duration-300 flex items-center gap-2 w-full sm:w-auto"
