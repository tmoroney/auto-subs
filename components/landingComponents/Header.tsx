  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-full sm:max-w-5xl px-2">
        <div
          className={`rounded-lg sm:rounded-full py-3 px-4 flex items-center justify-between bg-white/90 backdrop-blur-md shadow-lg transition-all duration-300 w-full max-w-full`}
        >
          <a className="flex items-center justify-center flex-shrink-0" href="#">
            ...
            <span className="ml-2 text-base sm:text-lg font-semibold text-gray-900 font-['Poppins'] hidden sm:block">AutoSubs</span>
          </a>
          <nav className="flex items-center gap-2 sm:gap-4">
            ...
            <button
              className="text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-full cursor-pointer transition-colors duration-300 whitespace-nowrap flex-shrink-0"
